...
{
    public class GetFileByIdResponseExampleModel : IExamplesProvider<FileStorageEntity>
    {
        public FileStorageEntity GetExamples() => new FileStorageEntity
        {
